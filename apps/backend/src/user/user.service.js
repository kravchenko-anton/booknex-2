    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            user = _a.sent();
            if (!user) throw new common_1.BadRequestException('User not found');
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_f) {
        switch (_f.label) {
          ...
          case 1:
            isSameUser = _f.sent();
            if (!isSameUser) throw new common_1.BadRequestException('User not found');
          ...
          case 5:
            return [
              4 /*yield*/,
              _b.apply(_a, [
                ((_d.data = ((_e.password = _c), (_e.name = dto.name ? dto.name : user.name), _e)),
                _d)
              ])
            ];
          case 6:
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            user = _c.sent();
            if (!user) return [2 /*return*/, new common_1.BadRequestException('User not found')];
            favoriteType =
              type === 'song'
                ? 'favoritesSong'
                : type === 'album'
            ...
            return [
              ...
              this.prisma.user.update({
                ...
                data:
                  ((_a = {}),
                  (_a[favoriteType] =
                    ((_b = {}), (_b[isFavorite ? 'disconnect' : 'connect'] = { id: +id }), _b)),
                  _a)
              })
            ];
          case 2:
