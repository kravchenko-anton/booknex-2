...
export const GenreApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    byId: async (id: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/genre/by-id/{id}`.replace(
        `{${'id'}}`,
...
export const GenreApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GenreByIdOutput>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.byId(id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['GenreApi.byId']?.[localVarOperationServerIndex]?.url;
    ...
    async catalog(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['GenreApi.catalog']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
