...
export const RecommendationApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async currentRecommendation(
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ShortGenre>>> {
    ...
    async updateRecommendation(
      ...
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateRecommendation(
        updateRecommendationDto,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['RecommendationApi.updateRecommendation']?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
