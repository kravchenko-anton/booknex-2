...
export const ParserApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    byId: async (id: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/parser/admin/by-id/{id}`.replace(
        `{${'id'}}`,
    ...
    remove: async (id: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      ...
      const localVarPath = `/api/parser/admin/remove/{id}`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ParserApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async byId(
      id: number,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BookTemplate>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.byId(id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ParserApi.byId']?.[localVarOperationServerIndex]?.url;
    ...
    async catalog(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<BookTemplateCatalogOutput>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.catalog(searchTerm, page, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ParserApi.catalog']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async parse(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ParserApi.parse']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async remove(
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ParserApi.remove']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    async unfold(
      file?: File,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<UnfoldOutput>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.unfold(file, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ParserApi.unfold']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
...
export const ParserApiFactory = function (
  ...
  return {
    ...
    catalog(
      ...
      page?: number,
      options?: any
    ): AxiosPromise<BookTemplateCatalogOutput> {
      return localVarFp
