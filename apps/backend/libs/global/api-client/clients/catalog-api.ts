...
export const CatalogApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeaturedOutput>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.featured(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CatalogApi.featured']?.[localVarOperationServerIndex]?.url;
    ...
    async search(
      query: string,
      options?: RawAxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ShortBook>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.search(query, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CatalogApi.search']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
