...
import { BookTemplateCatalogOutputSchema, BookTemplateSchema } from 'global/validation/parser/bookTemplate.schema';
...
export class BookTemplateCatalogOutput extends createZodDto(BookTemplateCatalogOutputSchema) {
}
