...
interface PageMarginSettingsProperties {
  padding: number;
  changePadding: ActionCreatorWithPayload<14 | 4 | 20, 'reading-ui/changePadding'>;
...
export const PageMarginSettings: FC<PageMarginSettingsProperties> = ({
  ...
  <View className='ml-4 flex-row items-center'>
    <PageMarginIcon
      ...
      backgroundColor={
        padding === 4 ? colorScheme.colorPalette.primary : colorScheme.colorPalette.text
      }
    ...
    <PageMarginIcon
      ...
      backgroundColor={
        padding === 14 ? colorScheme.colorPalette.primary : colorScheme.colorPalette.text
      }
    ...
    <PageMarginIcon
      ...
      backgroundColor={
        padding === 20 ? colorScheme.colorPalette.primary : colorScheme.colorPalette.text
      }
