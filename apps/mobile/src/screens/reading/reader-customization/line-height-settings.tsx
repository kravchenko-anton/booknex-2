...
interface LineHeightSettingsProperties {
  lineHeight: number;
  changeLineHeight: ActionCreatorWithPayload<1.3 | 1.5 | 1.8, 'reading-ui/changeLineHeight'>;
...
export const LineHeightSettings: FC<LineHeightSettingsProperties> = ({
  ...
  <View className='mr-4 flex-row items-center'>
    <LineHeightIcon
      lineCount={3}
      backgroundColor={
        lineHeight === 1.8 ? colorScheme.colorPalette.primary : colorScheme.colorPalette.text
      }
    ...
    <LineHeightIcon
      ...
      className='mx-3'
      backgroundColor={
        lineHeight === 1.5 ? colorScheme.colorPalette.primary : colorScheme.colorPalette.text
      }
    ...
    <LineHeightIcon
      lineCount={5}
      backgroundColor={
        lineHeight === 1.3 ? colorScheme.colorPalette.primary : colorScheme.colorPalette.text
      }
