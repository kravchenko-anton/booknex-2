...
const ProgressBar = ({
  ...
  const passedAnimatedValue = useRef<ProgressBarProperties['animatedValue']>(animatedValue);
  ...
  const startAnimation = useCallback(() => {
    ...
    const externalAnimation =
      passedAnimatedValue.current !== undefined && passedAnimatedValue.current >= 0;
                    ...
                    translateX: timer.interpolate(
                      indeterminate
                        ? {
                            ...
                            outputRange: [
                              (isRTL ? 1 : -1) * 0.5 * width,
                              (isRTL ? 1 : -1) * 0.5 * indeterminateMaxWidth * width,
                              (isRTL ? -1 : 1) * 0.7 * width
                            ]
                          }
                        : {
