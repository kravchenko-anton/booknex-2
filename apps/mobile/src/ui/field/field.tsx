    ...
    render={({ field: { value, onChange, onBlur }, fieldState: { error } }) => (
      <>
        <View
          style={style}
          className={cn(
            'relative my-1 flex w-full justify-center rounded border-[1px] border-transparent px-2',
            error && 'border-danger',
            Icon && 'pl-9',
        ...
        >
          ...
          />
          {Icon ? (
            <Icon width={20} color={Color.gray} height={20} className='absolute left-2.5' />
          ) : null}
        </View>
        {error ? (
