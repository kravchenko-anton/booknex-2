...
const VerticalCard = ({ ...card }) => (_jsxs(PressableContainer, {
	...
	}, className: 'bg-shade mb-1.5 w-full flex-row rounded-lg p-2', ...card, children: [_jsx(Image, { url: card.image.uri, height: heightSettings[card.image.size], fullSize: true, width: widthSettings[card.image.size] }), _jsxs(View, {
