...
const AnimatedIcon = ({ icon: Icon, variant = 'ghost', size = 'small', color = Color.black, backgroundColor, fatness = 2, style, noPadding = false, ...properties }) => (_jsx(PressableContainer, {
	className: 'items-center justify-center border-[2px]', style: [
		{
