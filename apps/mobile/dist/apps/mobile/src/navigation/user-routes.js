...
export const routes = [
    {
        ...
        options: {
            header: ({ navigation }) => (<Header.Head>
					...
					<Header.Icon className='pr-2' icon={SearchIcon} onPress={() => navigation.navigate('Search')}/>
				</Header.Head>),
            headerShown: true
        }
    },
    ...
    },
    {
        ...
        options: {
            header: ({ navigation }) => (<Header.Head>
					<Header.Logo className='pl-2'/>
					<Header.Icon className='pr-2' icon={SettingsIcon} onPress={() => navigation.navigate('Settings')}/>
				</Header.Head>),
            headerShown: true
        }
    },
