...
export const googleLogin = createAsyncThunk('auth/googleLogin', async ({ socialId }, thunkAPI) => {
    try {
...
export const mailRegister = createAsyncThunk('auth/mailRegister', async (properties, thunkAPI) => {
    try {
...
export const mailLogin = createAsyncThunk('auth/mailLogin', async ({ email, password }, thunkAPI) => {
    try {
