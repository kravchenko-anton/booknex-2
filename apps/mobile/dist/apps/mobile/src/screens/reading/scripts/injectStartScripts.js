import { calculateProgress, scrollCalculateProgress } from '@/screens/reading/scripts/calculate-progress';
import { selectTextLimitScript } from '@/screens/reading/scripts/text-selection-limit';
export const injectStartScripts = (startPosition) => `
<script>
					...
					`;
//# sourceMappingURL=injectStartScripts.js.map