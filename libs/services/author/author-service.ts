import type { CreateAuthorDto, EditAuthorDto } from '../../../apps/backend/src/author/dto/manipulation.author.dto'
import { getAuthorUrl } from '../api/api-config'
import { request } from '../api/request.api'
import type { AllAuthorOutput, InfoByIdOutput } from './author-types'
