import type { FilenameDto } from '../../../apps/backend/src/storage/dto/upload.dto'
import type { UserUpdateBioDto, UserUpdatePasswordDto } from '../../../apps/backend/src/user/dto/user.update.dto'
import type { UserLibraryCategoryType } from '../../../apps/backend/src/user/user.types'
import { getUsersUrl } from '../api/api-config'
import { request } from '../api/request.api'
import type { FavoriteListOutput, ToggleOutput, UserLibraryOutput, UserProfileOutput } from './user-types'
