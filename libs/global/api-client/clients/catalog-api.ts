...
export const CatalogApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        search: async (query: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/catalog/search/{query}`
...
export const CatalogApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async featured(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async search(query: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const CatalogApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        featured(options?: any): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        search(query: string, options?: any): AxiosPromise<void> {
