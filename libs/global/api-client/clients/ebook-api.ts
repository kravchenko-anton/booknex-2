	...
	return {
		...
		async ebookById(
			...
			(
				axios?: AxiosInstance,
				basePath?: string
			) => AxiosPromise<EbookByIdOutput>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.ebookById(
				id,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['EbookApi.ebookById']?.[localVarOperationServerIndex]
					?.url
		...
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.storedEbook(
				id,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['EbookApi.storedEbook']?.[
