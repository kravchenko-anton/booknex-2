...
export const StorageApiAxiosParamCreator = function (
	...
	return {
		...
		upload: async (
			...
			const localVarPath = `/api/storage/{folder}`.replace(
				`{${'folder'}}`,
				encodeURIComponent(String(folder))
			)
	...
	return {
		...
		> {
			...
			const localVarOperationServerBasePath =
				operationServerMap['StorageApi.upload']?.[localVarOperationServerIndex]
					?.url
...
export type UploadFolderEnum =
	(typeof UploadFolderEnum)[keyof typeof UploadFolderEnum]
