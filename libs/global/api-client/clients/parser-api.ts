...
export const ParserApiAxiosParamCreator = function (
	...
	return {
		...
		bySlug: async (
			...
			const localVarPath = `/api/parser/admin/by-slug/{slug}`.replace(
				`{${'slug'}}`,
		...
		remove: async (
			...
			const localVarPath = `/api/parser/admin/remove/{slug}`.replace(
				`{${'slug'}}`,
				encodeURIComponent(String(slug))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ParserApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async bySlug(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BookTemplate>
		> {
			...
			const localVarOperationServerBasePath =
				operationServerMap['ParserApi.bySlug']?.[localVarOperationServerIndex]
					?.url
		...
		> {
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['ParserApi.catalog']?.[localVarOperationServerIndex]
					?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
		...
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.parse(
				parserDto,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
		...
		> {
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['ParserApi.remove']?.[localVarOperationServerIndex]
					?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
		...
		async unfold(
			...
			(
				axios?: AxiosInstance,
				basePath?: string
			) => AxiosPromise<Array<UnfoldOutput>>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.unfold(
				file,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['ParserApi.unfold']?.[localVarOperationServerIndex]
					?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
