...
export const BookApiAxiosParamCreator = function (
	...
	return {
		...
		adminInfoBySlug: async (
			...
			const localVarPath = `/book/admin-info/by-slug/{slug}`.replace(
				`{${'slug'}}`,
		...
		infoBySlug: async (
			...
			const localVarPath = `/book/info/by-slug/{slug}`.replace(
				`{${'slug'}}`,
				encodeURIComponent(String(slug))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		remove: async (
			...
			const localVarPath = `/book/admin/remove/{slug}`.replace(
				`{${'slug'}}`,
				encodeURIComponent(String(slug))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		update: async (
			...
			const localVarPath = `/book/admin/update/{slug}`.replace(
				`{${'slug'}}`,
				encodeURIComponent(String(slug))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
