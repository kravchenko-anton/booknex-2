 ...
 * @export
 */
export const BookApiAxiosParamCreator = function (
	...
	return {
		...
		adminInfoById: async (
			...
			const localVarPath = `/api/book/admin-info/by-id/{id}`.replace(
				`{${'id'}}`,
		...
		infoById: async (
			...
			const localVarPath = `/api/book/info/by-id/{id}`.replace(
				`{${'id'}}`,
				encodeURIComponent(String(id))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		remove: async (
			...
			const localVarPath = `/api/book/admin/remove/{id}`.replace(
				`{${'id'}}`,
				encodeURIComponent(String(id))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		update: async (
			...
			const localVarPath = `/api/book/admin/update/{id}`.replace(
				`{${'id'}}`,
				encodeURIComponent(String(id))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		updateEbook: async (
			id: number,
			payloadEBook: Array<PayloadEBook>,
			options: RawAxiosRequestConfig = {}
		): Promise<RequestArgs> => {
			// verify required parameter 'id' is not null or undefined
			...
			const localVarPath = `/api/book/admin/update-ebook/{id}`.replace(
				`{${'id'}}`,
				encodeURIComponent(String(id))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		updateGenre: async (
			...
			const localVarPath = `/api/book/admin/update-genre/{id}`.replace(
				`{${'id'}}`,
				encodeURIComponent(String(id))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		updatePicture: async (
			...
			const localVarPath = `/api/book/admin/update-picture/{id}`.replace(
				`{${'id'}}`,
				encodeURIComponent(String(id))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
	...
	return {
		...
		async adminInfoById(
			...
			(
				axios?: AxiosInstance,
				basePath?: string
			) => AxiosPromise<AdminInfoByIdOutput>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.adminInfoById(
				id,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['BookApi.adminInfoById']?.[
		...
		async catalog(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CatalogOutput>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.catalog(
				searchTerm,
				page,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['BookApi.catalog']?.[localVarOperationServerIndex]
					?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
		...
		> {
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['BookApi.create']?.[localVarOperationServerIndex]
					?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
		...
		async infoById(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InfoByIdOutput>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.infoById(
				id,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['BookApi.infoById']?.[localVarOperationServerIndex]
					?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
		...
		> {
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['BookApi.remove']?.[localVarOperationServerIndex]
					?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
		...
		> {
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['BookApi.update']?.[localVarOperationServerIndex]
					?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
		...
		async updateEbook(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.updateEbook(
				id,
				payloadEBook,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['BookApi.updateEbook']?.[
					localVarOperationServerIndex
				]?.url
			return (axios, basePath) =>
				createRequestFunction(
		...
		async updateGenre(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.updateGenre(
				id,
				updateGenreDto,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['BookApi.updateGenre']?.[
					localVarOperationServerIndex
				]?.url
			return (axios, basePath) =>
				createRequestFunction(
		...
		async updatePicture(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.updatePicture(
				id,
				picture,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['BookApi.updatePicture']?.[
					localVarOperationServerIndex
				]?.url
			return (axios, basePath) =>
				createRequestFunction(
 ...
 * @export
 */
export const BookApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance
) {
	...
	return {
		...
		catalog(
			...
			page: number,
			options?: any
		): AxiosPromise<CatalogOutput> {
			return localVarFp
				.catalog(searchTerm, page, options)
				.then(request => request(axios, basePath))
		},
		/**
		 *
		...
		update(
			...
			return localVarFp
				.update(id, updateBookDto, options)
				.then(request => request(axios, basePath))
		},
		/**
		 *
		...
		updateEbook(
			...
			return localVarFp
				.updateEbook(id, payloadEBook, options)
				.then(request => request(axios, basePath))
		},
		/**
		 *
		...
		updateGenre(
			...
			return localVarFp
				.updateGenre(id, updateGenreDto, options)
				.then(request => request(axios, basePath))
		},
		/**
		 *
		...
		updatePicture(
			...
			return localVarFp
				.updatePicture(id, picture, options)
				.then(request => request(axios, basePath))
		}
	}
}
