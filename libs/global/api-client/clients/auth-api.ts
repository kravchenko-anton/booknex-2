...
export const AuthApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async googleSign(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthOutput>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.googleSign(
				googleAuthDto,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['AuthApi.googleSign']?.[localVarOperationServerIndex]
					?.url
		...
		async mailLogin(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthOutput>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.mailLogin(
				authDto,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['AuthApi.mailLogin']?.[localVarOperationServerIndex]
					?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
		...
		async mailRegister(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthOutput>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.mailRegister(
				authDto,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['AuthApi.mailRegister']?.[
