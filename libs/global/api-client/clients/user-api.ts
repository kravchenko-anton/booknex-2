...
export const UserApiAxiosParamCreator = function (
	...
	return {
		...
		finishReading: async (
			...
			const localVarPath = `/user/finish-reading/{slug}`.replace(
				`{${'slug'}}`,
		...
		isSaved: async (
			...
			const localVarPath = `/user/is-saved/{slug}`.replace(
				`{${'slug'}}`,
				encodeURIComponent(String(slug))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		remove: async (
			...
			const localVarPath = `/user/admin/remove/{id}`.replace(
				`{${'id'}}`,
		...
		startReading: async (
			...
			const localVarPath = `/user/start-reading/{slug}`.replace(
				`{${'slug'}}`,
				encodeURIComponent(String(slug))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		toggleSave: async (
			...
			const localVarPath = `/user/toggle-save/{slug}`.replace(
				`{${'slug'}}`,
				encodeURIComponent(String(slug))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const UserApiFactory = function (
	...
	return {
		...
		catalog(
			...
			return localVarFp
				.catalog(searchTerm, cursor, options)
