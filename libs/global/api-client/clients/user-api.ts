...
export const UserApiAxiosParamCreator = function (
	...
	return {
		...
		finishReading: async (
			...
			const localVarPath = `/api/user/finish-reading/{id}`.replace(
				`{${'id'}}`,
		...
		isSaved: async (
			...
			const localVarPath = `/api/user/is-saved/{id}`.replace(
				`{${'id'}}`,
				encodeURIComponent(String(id))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		startReading: async (
			...
			const localVarPath = `/api/user/start-reading/{id}`.replace(
				`{${'id'}}`,
				encodeURIComponent(String(id))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		toggleSave: async (
			...
			const localVarPath = `/api/user/toggle-save/{id}`.replace(
				`{${'id'}}`,
				encodeURIComponent(String(id))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
