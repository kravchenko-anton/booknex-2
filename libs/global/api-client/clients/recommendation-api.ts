...
export const RecommendationApiFp = function (configuration?: Configuration) {
	const localVarAxiosParamCreator =
		RecommendationApiAxiosParamCreator(configuration)
	return {
		/**
		 *
		 * @param {*} [options] Override http request option.
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.currentRecommendation(options)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['RecommendationApi.currentRecommendation']?.[
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.updateRecommendation(
					updateRecommendationDto,
					options
				)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['RecommendationApi.updateRecommendation']?.[
					localVarOperationServerIndex
				]?.url
			return (axios, basePath) =>
				createRequestFunction(
...
export const RecommendationApiFactory = function (
	...
	return {
		...
		updateRecommendation(
			...
			return localVarFp
				.updateRecommendation(updateRecommendationDto, options)
				.then(request => request(axios, basePath))
		}
	}
}
