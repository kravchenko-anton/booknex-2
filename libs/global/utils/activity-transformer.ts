...
export const transformActivity = (activities: ActivitiesProperties[]): ActivitiesOutput[] => {
  const activitiesByDate = activities.reduce<ActivitiesByDate>((accumulator, activity) => {
